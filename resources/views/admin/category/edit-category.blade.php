        ...
        <div class="row justify-content-center">
            <div class="col-lg-9">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    ...
                    <div class="card-body">
                        <form name="edit_form" action="{{route('new-category')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="mb-3 row">
                                <label class="col-sm-2 col-form-label">Category Name</label>
                                <div class="col-sm-10">
                                    <input type="hidden" name="id" id="" value="{{$category->id}}">
                                    <input type="text" name="category_name" value="{{$category->category_name}}" placeholder="Enter Your Title Name"  class="form-control" >
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-3">
                                    <div class="input-group">
                                        <img id="img" src="{{asset($category->image)}}" alt="" style="height: 150px; width: 150px">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-10 mt-1">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="publication_status" id="inlineRadio2"
                                               @if($category->publication_status==2)
                                               checked
                                               @endif
                                               value="2">
